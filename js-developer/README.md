...
1. Add support for multiple languages.
    1. Texts in the UI should be displayed according to the current language
    1. The user should be able to select between different languages
...
### Other Requirements
We want to see what you are capable of and this is why we are giving you a lot of freedom to approach the challenge. We not only want to see your code but also your technical assesment of the problem, architectural decision making and technology choices. Please keep in mind.
